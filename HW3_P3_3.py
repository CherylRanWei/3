...
print '************** Problem 2 **************'
'''
 Figure 3_3.jpg for implementation
'''

X = cv2.imread('3_3.jpg')
img = cv2.cvtColor(X, cv2.COLOR_BGR2HSV)

'''
Origianl Histogram and CDF Graph for 3_3.jpg
'''
...
plt.ylabel('Counts')
plt.grid(True)
plt.savefig('Histogram of Original 3_3.png')
...
plt.grid(True)
plt.ylabel("CDF")
plt.savefig('CDF of Original 3_3.png')


'''
Linear Stretched Histogram and CDF Graph for 3_3.jpg
'''
ls_img = cv2.cvtColor(X, cv2.COLOR_BGR2HSV)
function.LinStrtch(ls_img, 175)   # linear stretching
...
plt.ylabel('Counts')
plt.grid(True)
plt.savefig('Histogram of Linear Stretching 3_3.png')
...
plt.grid(True)
plt.ylabel("CDF")
plt.savefig('CDF of Linear Stretching 3_3.png')



'''
Histogram Equalization and CDF Graph for 3_3.jpg
'''
...
plt.ylabel('Counts')
plt.grid(True)
plt.savefig('Histogram of Histogram Equalization 3_3.png')
...
plt.grid(True)
plt.ylabel("CDF")
plt.savefig('CDF of Histogram Equalization 3_3.png')


'''
Histogram Specification and CDF Graph for 3_3.jpg
'''
mu = 10
sigma = 40
...
plt.ylabel('Counts')
plt.grid(True)
plt.savefig('Histogram of Histogram Specification 3_3.png')
...
plt.grid(True)
plt.ylabel("CDF")
plt.savefig('CDF of Histogram Specification 3_3.png')


'''
Convert to RGB for Display and Save After Linear Stretching for 3_3.jpg
'''
...
plt.savefig('Linear Stretching for 3_3.png')


'''
Convert to RGB for Display and Save After Histogram Equalization for 3_3.jpg
'''
...
plt.savefig('Histogram Equalization for 3_3.png')


'''
Convert to RGB for Display and Save After Specification for 3_3.jpg
'''
...
plt.savefig('Specification for 3_3.png')
